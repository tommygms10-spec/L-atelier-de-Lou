      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="relative aspect-[4/5] max-w-md mx-auto rounded-[2rem] overflow-hidden shadow-premium group">
            <Image
              src="/images/nail-marbre-or.jpg"
              alt="Réalisation onglerie Maison Lou — manucure marbrée blanche et dorée"
              fill
              className="object-cover transition-transform duration-700 group-hover:scale-105"
              sizes="(max-width: 768px) 100vw, 480px"
            />
            <div className="absolute inset-0 ring-1 ring-inset ring-dore-subtil/30 rounded-[2rem]" />
            <div className="absolute inset-0 bg-gradient-to-t from-noir-elegant/50 via-transparent to-transparent" />
            <div className="absolute bottom-6 left-6 right-6 text-ivory">
              <div className="flex items-center gap-2 mb-1">
                <Sparkles size={14} className="text-dore-subtil" />
                <span className="text-xs tracking-wide uppercase">Travail de Lou</span>
              </div>
              <p className="font-display text-lg">Précision &amp; créativité</p>
            </div>
          </div>
